...
/// <summary>
/// NodePreact view engine.
/// </summary>
public class NodePreactViewEngine : IViewEngine
{
    ...
    public NodePreactViewEngine(string prefix = "$", string defaultView = "")
    {
        _prefix = prefix;
    ...
    public ViewEngineResult GetView(string executingFilePath, string viewPath, bool isMainPage)
    {
        ...
        if (_prefix.Length > 0)
        {
            ...
            {
                return ViewEngineResult.Found(viewPath, new NodePreactView(componentName));
            }
        } 
        else if (_defaultView.Length > 0)
        {
            return ViewEngineResult.Found(_defaultView, new NodePreactView(_defaultView));
        }
